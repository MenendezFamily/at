 ...
 */
function MarkerLight(latlng, content, num, opts) {
  this.latlng = latlng;
...
MarkerLight.prototype.initialize = function(map) {
  ...
  div.style.marginLeft = "-" + Math.floor(me.width_/2) + "px";
  //div.style.marginTop = Math.floor(me.height_/2) + "px";
...
MarkerLight.prototype.copy = function() {
  ...
  return new MarkerLight(this.latlng, this.content, this.num, opts);
};
